...
def load_text_mappings():
    """Load text mappings from X4 localization files."""
    global TEXT_MAPPINGS
    if TEXT_MAPPINGS:  # Already loaded
        return
    
    text_file = Path("data/t/0001-l044.xml")
    ...
    try:
        ...
        print(f"Loaded {len(TEXT_MAPPINGS)} text mappings from localization file")
    except ET.ParseError:
        print(f"⚠️ Failed to parse text file {text_file}")
